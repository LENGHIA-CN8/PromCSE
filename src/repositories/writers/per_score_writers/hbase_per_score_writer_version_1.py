...
class HbasePerScoreWriterVersion1(BaseHbasePerScoreWriterVersion1):
    """
    ...
    def __init__(
        ...
        """
        super(HbasePerScoreWriterVersion1, self).__init__(
...
class HbasePerScoreWriterVersion1Config(BaseHbasePerScoreWriterVersion1Config):
    """
    ...
    def __init__(
        ...
        :param verbose: display progress bar
        """
        super(HbasePerScoreWriterVersion1Config, self).__init__(
