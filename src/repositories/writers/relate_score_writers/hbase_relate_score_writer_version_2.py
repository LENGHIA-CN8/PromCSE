...
class HbaseRelateScoreWriterVersion2(BaseHbaseRelateScoreWriterVersion1):
    """
    ...
    def __init__(
        ...
        """
        super(HbaseRelateScoreWriterVersion2, self).__init__(
...
class HbaseRelateScoreWriterVersion2Config(BaseHbaseRelateScoreWriterVersion1Config):
    """
    ...
    def __init__(
        ...
        :param verbose: display progress bar
        """
        super(HbaseRelateScoreWriterVersion2Config, self).__init__(
