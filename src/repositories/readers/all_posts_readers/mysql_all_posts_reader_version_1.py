...
class MySQLAllPostsReaderVersion1(BaseMySQLAllPostsReaderVersion1):
    """
    ...
    def __init__(
        ...
        """
        super(MySQLAllPostsReaderVersion1, self).__init__(
            connector=connector
        )
...
class MySQLAllPostsReaderVersion1Config(BaseMySQLAllPostsReaderVersion1Config):
    """
    ...
    def __init__(
        ...
        :param hour_window: only read posts that were published in recent x hours
        """
        super(MySQLAllPostsReaderVersion1Config, self).__init__(
